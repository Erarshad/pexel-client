...
class _imagesState extends State<images> {
  Future<ImageSource?>? image_data;
  @override
  void initState() {
    handle_request("https://api.pexels.com/v1/curated/?page=1&per_page=7");
    super.initState();
  }
  ...
  void handle_request(String url) {
    if (this.mounted) {
      setState(() {
        image_data = apis.images(url, context);
            ...
            child: Container(
                child: FutureBuilder(
                    ...
                    builder: (BuildContext context,
                        AsyncSnapshot<ImageSource?> snapshot) {
